...
# ── Imprimir varias líneas con asteriscos
# ── Más a delante veremos cómo automatizar esto. De momento
# ── las imprimimos a saco
print("*" * 60)
print("*" * 60)
print("*" * 60)
print("*" * 60)
...
# ── Posicionar cursor en la fila intermedia
print(ESC + '[10;1f', end='', flush=True)
time.sleep(WAIT)

# ── Borrar desde el cursor hacia arriba
print(CLEAR_UP, end='', flush=True)
time.sleep(WAIT)

# ── Borrar desde el cursor hacia abajo
